...
public class SinglyLinkedList<E> implements ListInterface<E>{
	...
	/**
	 * removeFirst was created only to be used for Program 3 assignment, it removes the element in the 
	 * head of the linked list, since that removeElementAtPosition was too big
	...
	public E removeFirst(){
		...
		if(size() == 1){
			tail = null;    // if there is only one element, the linked list will be totally emptied and the tail should point to null. 
		}
